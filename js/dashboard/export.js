  ...
  const EXPORT_FIELDS = [
    ...
    { id:'funcoes_preferidas', label:'Equipe de trabalho', group:'completo', get:r => Array.isArray(r.funcoes_preferidas) ? r.funcoes_preferidas.join('; ') : '' },
  ...
  const PRESETS = {
    ...
    contato: ['nome','whatsapp','instagram','cidade','uf','decuria','status'],
  ...
  function printStyles(){
    return (
      ...
      '.banner-text h1{font-family:Outfit,Impact,sans-serif;font-size:26px;margin:0;letter-spacing:.04em;text-transform:uppercase;line-height:1.05;}' +
